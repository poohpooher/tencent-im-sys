...
static const char* kTIMInternalOperationSetConversationGroupOrderData = "internal_operation_set_conversation_group_order_data";
static const char* kTIMInternalOperationGetConversationGroupOrderData = "internal_operation_get_conversation_group_order_data";
static const char* kTIMInternalOperationQueryCommercialAbilityBits = "internal_operation_query_commercial_ability_bits";
static const char* kTIMInternalOperationGetLoginAccountType = "internal_operation_get_login_account_type";
static const char* kTIMInternalOperationGetOfficialAccountList = "internal_operation_get_official_account_list";
static const char* kTIMInternalOperationReportRoomEngineEvent = "internal_operation_report_room_engine_event";
static const char* kTIMInternalOperationUploadFile = "internal_operation_upload_file";
static const char* kTIMInternalOperationConvertVoiceToText = "internal_operation_convert_voice_to_text";
...
// bool, 只写(选填), 是否 TLS 地址，默认为 false
static const char* kTIMServerAddressIsTLS = "server_address_is_tls";
...
// string, 只写(选填), 设置会话分组排序信息, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationSetConversationGroupOrderData 时需要设置
static const char* kTIMRequestSetConversationGroupOrderDataParam = "request_set_conversation_group_order_data_param";
// int32, 只写(选填), 请求公众号的数量, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationGetOfficialAccountList 时需要设置
static const char* kTIMRequestGetOfficialAccountListCount = "request_get_official_account_list_count";
// uint64, 只写(选填), 请求公众号的游标, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationGetOfficialAccountList 时需要设置
static const char* kTIMRequestGetOfficialAccountListOffset = "request_get_official_account_list_offset";
// string, 只写(必填), 文件路径, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationUploadFile 时需要设置
static const char* kTIMRequestUploadFileFilePath = "request_upload_file_file_path";
// int32, 只写(选填), 文件类型 (0:未知, 1:图片, 2:视频, 3:音频, 4:日志文件, 默认0), 当 kTIMRequestInternalOperation 为 kTIMInternalOperationUploadFile 时需要设置
static const char* kTIMRequestUploadFileFileType = "request_upload_file_file_type";
// string, 只写(必填), 语音URL, 当 kTIMRequestInternalOperation 为 kTIMInternalOperationConvertVoiceToText 时需要设置
static const char* kTIMRequestConvertVoiceToTextURL = "request_convert_voice_to_text_url";
// string, 只写(选填), 语言 (空表示自动检测), 当 kTIMRequestInternalOperation 为 kTIMInternalOperationConvertVoiceToText 时需要设置
static const char* kTIMRequestConvertVoiceToTextLanguage = "request_convert_voice_to_text_language";
...
// int32, 只读(选填), 返回所有公众号的数量, 当 kTIMResponseInternalOperation 为 kTIMInternalOperationGetOfficialAccountList 时需要设置
static const char* kTIMResponseOfficialAccountListTotalCount = "response_official_account_list_total_count";
// uint64, 只读(选填), 请求公众号的游标, 当 kTIMResponseInternalOperation 为 kTIMInternalOperationGetOfficialAccountList 时需要设置
static const char* kTIMResponseOfficialAccountListNextOffset = "response_official_account_list_next_offset";
// array @ref OfficialAccountInfo, 只读(选填), 响应的公众号列表, 当 kTIMResponseInternalOperation 为 kTIMInternalOperationGetOfficialAccountList 时有值
static const char* kTIMResponseOfficialAccountList = "response_official_account_list";
// string, 只读(选填), 上传文件后的URL, 当 kTIMResponseInternalOperation 为 kTIMInternalOperationUploadFile 时有值
static const char* kTIMResponseUploadFileURL = "response_upload_file_url";
// string, 只读(选填), 语音识别的文本结果, 当 kTIMResponseInternalOperation 为 kTIMInternalOperationConvertVoiceToText 时有值
static const char* kTIMResponseConvertVoiceToTextResult = "response_convert_voice_to_text_result";

// 4.15 ReportRoomEngineEvent(RoomEngine 事件上报的参数)
// uint32_t, 只写(必填)
static const char* kTIMReportRoomEngineEventParamEventID = "report_room_engine_event_param_event_id";
// uint32_t, 只写(选填)
static const char* kTIMReportRoomEngineEventParamEventCode = "report_room_engine_event_param_event_code";
// uint32_t, 只写(选填)
static const char* kTIMReportRoomEngineEventParamEventResult = "report_room_engine_event_param_event_result";
// string, 只写(选填)
static const char* kTIMReportRoomEngineEventParamEventMessage = "report_room_engine_event_param_event_message";
// string, 只写(选填)
static const char* kTIMReportRoomEngineEventParamMoreMessage = "report_room_engine_event_param_more_message";
// string, 只写(选填)
static const char* kTIMReportRoomEngineEventParamExtensionMessage = "report_room_engine_event_param_extension_message";

// 4.16 ReportTUIFeatureUsage(Atomicx 上报)
static const char* kTIMReportTUIFeatureUsage = "report_tuifeature_usage";
static const char* kTIMReportTUIFeatureUsageUIComponentType = "report_tuifeature_usage_uicomponent_type";
static const char* kTIMReportTUIFeatureUsageUIFeatureType = "report_tuifeature_usage_uifeature_type";
